...
IsEnough proc
    inc stringinfile
    push bx
    cmp counter,0;prover perepolnenije
    ja EndIsEnough 
    cmp si,localsize  ;sravn s dlinnoi
    jae EndIsEnough ;esli bolshe ili rovno skip
finaly:    
    inc number;nomer pered skobkoi
    push ax
    mov ax,number
    call Show_AX;vivod chisla
    pop ax
    Print_str StringScobka
    Print_str StringinFileMsg
    push ax
    mov ax,stringinfile;vivodim nomer stroki kot uvel v ifenough
    call Show_AX
